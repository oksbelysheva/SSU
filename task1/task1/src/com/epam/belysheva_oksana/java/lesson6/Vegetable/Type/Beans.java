...
public class Beans implements Vegetable {
    private static VegetableType vegetableType = VegetableType.BEANS;
    ...
    public Beans(String name, double calories, double protein, double carbohydrates, WayForEating wayForEating) throws InvalidVegetableCharacteristicException {
