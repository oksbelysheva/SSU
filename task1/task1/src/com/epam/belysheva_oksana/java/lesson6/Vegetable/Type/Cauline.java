...
lesson6
 */
public class Cauline implements Vegetable {
    private static VegetableType vegetableType = VegetableType.CAULINE;
    ...
    public Cauline(String name, double calories, double protein, double carbohydrates, WayForEating wayForEating) throws InvalidVegetableCharacteristicException {
