...
public class Root implements Vegetable {
    private static VegetableType vegetableType = VegetableType.ROOT;
    ...
    public Root(String name, double calories, double protein, double carbohydrates, WayForEating wayForEating) throws InvalidVegetableCharacteristicException {
