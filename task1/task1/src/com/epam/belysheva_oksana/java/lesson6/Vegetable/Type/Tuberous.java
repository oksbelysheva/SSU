package com.epam.belysheva_oksana.java.lesson6.Vegetable.Type;
...
import com.epam.belysheva_oksana.java.lesson6.Vegetable.VegetableType;
import com.epam.belysheva_oksana.java.lesson6.Vegetable.WayForEating;

/*
BelyshevaOA 531
lesson6
 */
public class Tuberous implements Vegetable {
    private static VegetableType vegetableType = VegetableType.TUBEROUS;
    ...
    public Tuberous(String name, double calories, double protein, double carbohydrates, WayForEating wayForEating) throws InvalidVegetableCharacteristicException {
