...
public class Beans implements Vegetable {
    private VegetableType type = VegetableType.BEANS;
    private String name;
    ...
    public Beans(String name, NutritiveValue nutritiveValue, WayForEating wayForEating, Vitamins vitamins, VisualParametrs visualParametrs) throws InvalidVegetableCharacteristicException {
