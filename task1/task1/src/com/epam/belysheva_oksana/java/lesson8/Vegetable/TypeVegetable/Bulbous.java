...
public class Bulbous implements Vegetable {
    private VegetableType type = VegetableType.BULBOUS;
    ...
    public Bulbous(String name, NutritiveValue nutritiveValue, WayForEating wayForEating, Vitamins vitamins, VisualParametrs visualParametrs) throws InvalidVegetableCharacteristicException {
