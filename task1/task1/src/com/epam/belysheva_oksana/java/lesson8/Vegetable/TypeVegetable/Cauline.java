...
public class Cauline implements Vegetable {
    private VegetableType type = VegetableType.CAULINE;
    ...
    public Cauline(String name, NutritiveValue nutritiveValue, WayForEating wayForEating, Vitamins vitamins, VisualParametrs visualParametrs) throws InvalidVegetableCharacteristicException {
