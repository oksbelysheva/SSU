...
public class Tuberous implements Vegetable {
    private VegetableType type = VegetableType.TUBEROUS;
    ...
    public Tuberous(String name, NutritiveValue nutritiveValue, WayForEating wayForEating, Vitamins vitamins, VisualParametrs visualParametrs) throws InvalidVegetableCharacteristicException {
